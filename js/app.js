...
const scoreFeedback = (userScore) => {
  ...
  if (userScore >= 80 && userScore <= 100) {
    confettiStart();
    resultFeedback.textContent = `You are an expert in Node.JS, Great job on your exceptional performance! Keep up the excellent work and continue to demonstrate your skills.`;
  } else if (userScore >= 60 && userScore < 80) {
    confettiStart();
    resultFeedback.textContent = `You have a solid understanding of Node.JS, Keep working to enhance your skills and understanding. Your performance is good, but with more practice and focus, you can truly excel in this subject. `;
  } else if (userScore >= 40 && userScore < 60) {
    confettiStart();
    resultFeedback.textContent = `You have a decent grasp of Node.js, but there is room for growth. It's crucial to keep practicing and reviewing the material to strengthen your understanding and skills. I recommend seeking additional
                                   resources and assistance to help you improve in this subject.`;
  } else {
    confetti.clear();
    resultExpression.textContent = `Needs Improvement!!!`;
    resultFeedback.textContent = `The outcome of this quiz is not up to the mark, indicating a limited grasp of JavaScript. It's essential to invest extra effort and seek help to improve your comprehension and skills in this area. I recommend revisiting the material and practicing consistently to enhance your performance.`;
  }
};
